...
| art/hero-berserker.png | berserker | 광폭 전사, 번개·붉은 오라, 폭주 | 광폭화 |
| art/hero-warden.png | warden | 중장 방패 수호기사, 철벽 | 철벽 |
| art/hero-ranger.png | ranger | 정밀 저격수, 다중 조준, 민첩 | 일제사격 |
| art/hero-mech.png | mech | 강습 메카, 돌격 추진기 | 강습 |
| art/hero-engineer.png | engineer | 수리·건설 엔지니어, 드론·도구 | 긴급 수리 |
| art/hero-dragoon.png | dragoon | 용기사/마룡, 최강 보스급 위압 | 드래곤 강림 |

## hbtn / Legion Command Center용 소형 아이콘 (선택, premium)
> art/heroicon-<key>.png (64-128px crop safe). Dramatic god-pose close crop, gold rim hint, per-hero tint glow, centered bust/shoulder, dark bg. hbtn에 .him으로 lazy 로드 가능 (emoji fallback 유지).
