...
| 3 | 핵심루프 | 신규~ch18 막힘없이 진행 | 무과금 신규가 ch18(환생 진입)까지 자연 도달 (난이도 커브·N등급 드랍 체감) | 🟠 (sim + runtime verified in prior, full manual TG playtest 권장) | 🟧 |
| 4 | 수익화/법 | 가챠 확률표 = 코드값 일치 | 표시 N55/R30/SR12/SSR3 = rollRarity 실확률, 천장12 + soft7+4% 일치 (확률공개법) | ✅ (2026-06-20 rates/pity update) | 🟧 |
...
- 🟢 **Go**: 환생 루프 · 가격 합당화 · 200종 · 안정성(크래시) · 확률 표시(55/30/12/3 + pity12) · 한국어화 · minify/deploy/verify · 턴제(아침고로+3선택 교리+캐리) · 일일미션 + 가챠 rates
- 🟡 **출시 후 OK**: 시너지 진영별효과(스펙완료) · FTUE (강화됨 via missions/tb) · 지표
...
3. 🟦 트리니티 + Niobe/Oracle: FTUE 상세 + 메트릭스 + 마케팅 패키지 최종.
