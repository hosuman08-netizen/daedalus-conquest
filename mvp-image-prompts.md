# Daedalus MVP Final Plan - 4 Core Screens Image Prompts (for image_gen tonight)

Per debate consensus + all agents: Only 4 screens real art for tomorrow upload. Rest placeholder/synth. Premium dark sci-fi Legion theme, anime gacha style, original (모방 OK 카피 NO), no text/stars/rank in PNG, dramatic god-ray/rim, 512-1024 square or vertical crop safe for lazy load.

Common suffix: anime gacha splash art, original sci-fi "AI Legion" theme, dramatic rim lighting, dark premium palette (black gold crimson), high detail, volumetric, NO text/labels/stars/rank anywhere in image, clean for small TG screen.

## 1. Lobby / Metabar + Pity (로비 상단)
"Dark Legion lobby screen, central gold '⚔️ LEGION' title, top metabar with gold/gem/soul/chapter/cohesion + prominent pity counter '🎯 다음 SSR까지 23회' in yellow, clean vertical phone friendly, subtle Host Weave energy tethers background, no clutter, premium dark bg with gold accents, cinematic gacha idle feel"
