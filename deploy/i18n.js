...
const I18N = {
  ko: { statsTitle:"내 군단 통계",statBest:"최고 챕터",statCollect:"수집",statRebirth:"환생",statPower:"군단 전력",statPulls:"누적 뽑기",statWins:"누적 승리", carryVolume:"물량 군집",carrySeal:"캐리 — 네 지휘가 봉인했다",carryLed:"주도",vanguardFocus:"🔥 선봉대 24시간 집중",
    ...
    spTitle: "💎 초심자 패키지", sp1: "⚡ 전투 속도 2x 영구 해금", sp2: "💰 골드 3,000 즉시 지급", sp3: "📈 골드 획득 영구 +20%", sp4: "🎰 유닛 10개 즉시 + 영구 혜택", spPrice: "단 한 번 · ₩990",
  ...
  en: { statsTitle:"Legion Stats",statBest:"Best chapter",statCollect:"Collected",statRebirth:"Rebirths",statPower:"Legion power",statPulls:"Total pulls",statWins:"Total wins", carryVolume:"Swarm volume",carrySeal:"carried — your command sealed it",carryLed:"led",vanguardFocus:"🔥 Vanguard 24h Focus",
    ...
    spTitle: "💎 Starter Pack", sp1: "⚡ Permanent 2x battle speed", sp2: "💰 3,000 gold instantly", sp3: "📈 +20% gold gain forever", sp4: "🎰 10 units + permanent benefits", spPrice: "One time · $0.99",
    ...
    tStarter: "💎 Starter Pack acquired! Permanent 2x speed + 3000 gold + 10 units", tOwned: "Already owned — 2x speed active",
  ...
  ja: { statsTitle:"軍団統計",statBest:"最高章",statCollect:"収集",statRebirth:"転生",statPower:"軍団戦力",statPulls:"累計ガチャ",statWins:"累計勝利", carryVolume:"物量スウォーム",carrySeal:"キャリー — 君の指揮が決めた",carryLed:"主導",vanguardFocus:"🔥 先鋒隊24時間集中",
    ...
    spTitle: "💎 初心者パック", sp1: "⚡ 戦闘速度2x永久解放", sp2: "💰 ゴールド3,000即時支給", sp3: "📈 ゴールド獲得永久+20%", sp4: "🎰 ユニット10体即時 + 永久特典", spPrice: "一度きり · ¥160",
    ...
    tStarter: "💎 初心者パック獲得! 2x速度永久 + ゴールド3000 + ユニット10体", tOwned: "所持済み — 2x速度適用中",
  ...
  zh: { statsTitle:"军团统计",statBest:"最高章节",statCollect:"收集",statRebirth:"转生",statPower:"军团战力",statPulls:"累计抽卡",statWins:"累计胜利", carryVolume:"数量蜂群",carrySeal:"carry — 你的指挥锁定胜局",carryLed:"主导",vanguardFocus:"🔥 先锋队24小时专注",
    ...
    spTitle: "💎 新手礼包", sp1: "⚡ 永久解锁2倍速度", sp2: "💰 立即3,000金币", sp3: "📈 金币获取永久+20%", sp4: "🎰 立即10个单位 + 永久特权", spPrice: "仅一次 · ¥6",
    ...
    tStarter: "💎 新手礼包获得! 2x速度永久 + 3000金币 + 10单位", tOwned: "已拥有 — 2x速度已激活",
  ...
  hi: { statsTitle:"लीजन आँकड़े",statBest:"सर्वश्रेष्ठ अध्याय",statCollect:"संग्रह",statRebirth:"पुनर्जन्म",statPower:"लीजन शक्ति",statPulls:"कुल पुल",statWins:"कुल जीत", carryVolume:"झुंड दम",carrySeal:"carry — आपकी कमान ने जीत दिलाई",carryLed:"नेतृत्व",vanguardFocus:"🔥 अग्रदल 24घं फोकस",
    ...
    spTitle: "💎 स्टार्टर पैक", sp1: "⚡ स्थायी 2x युद्ध गति अनलॉक", sp2: "💰 3,000 गोल्ड तुरंत", sp3: "📈 गोल्ड लाभ हमेशा +20%", sp4: "🎰 10 यूनिट तुरंत + स्थायी लाभ", spPrice: "एक बार · ₹79",
    ...
    tStarter: "💎 स्टार्टर पैक प्राप्त! स्थायी 2x गति + 3000 गोल्ड + 10 यूनिट", tOwned: "पहले से — 2x गति सक्रिय",
  ...
  ru: { statsTitle:"Статистика",statBest:"Лучшая глава",statCollect:"Собрано",statRebirth:"Перерождения",statPower:"Сила легиона",statPulls:"Всего круток",statWins:"Всего побед", carryVolume:"Рой массой",carrySeal:"вынес — твоё командование решило",carryLed:"вёл",vanguardFocus:"🔥 Авангард 24ч фокус",
    ...
    spTitle: "💎 Набор новичка", sp1: "⚡ Постоянная скорость 2x", sp2: "💰 3,000 золота сразу", sp3: "📈 +20% золота навсегда", sp4: "🎰 10 юнитов сразу + постоянные бонусы", spPrice: "Один раз · 99₽",
    ...
    tStarter: "💎 Набор новичка получен! Постоянная 2x скорость + 3000 золота + 10 юнитов", tOwned: "Уже есть — 2x скорость активна",
...
Object.assign(I18N.ko, { evSeason: "시즌 이벤트", shopGacha: "뽑기", shopPack: "패키지 · 재화", seasonSoon: "시즌 이벤트 준비중", seasonHint: "곧 한정 이벤트·랭킹 보상이 열립니다", tArenaDone: "오늘 아레나 5회 완료", tArenaMatch: "아레나 매칭 (placeholder) — Phase2에서 풀 구현", tMystery: "❓ ??? : 비밀의 레기온 창. 곧 공개될 새로운 모드! 지금은... 궁금증만 폭발?", tCampaignCh: "📖 캠페인 ch", tSoulShop: "소울 상점", tDismantle: "🔮 중복 캐릭터 전부 소울로 분해 <small>(첫 장 보존·SSR 제외)</small>", tAscBanner: "🔄 <b>환생 가능</b> · 지금 환생 시 ⬡ +{e} <span class=\"asc-prompt-cta\">탭 →</span>", tCampaignChLabel: "📖 캠페인 ch", synHeader: "⚡ 군단 시너지", diversity: "다양성" });
Object.assign(I18N.en, { evSeason: "Season Event", shopGacha: "Summon", shopPack: "Packs · Currency", seasonSoon: "Season event soon", seasonHint: "Limited events & ranking rewards coming", tArenaDone: "Arena 5 runs done today", tArenaMatch: "Arena match (placeholder) — full in Phase2", tMystery: "❓ ??? : Secret Legion window. New mode coming soon! For now... pure curiosity?", tCampaignCh: "📖 Campaign ch", tSoulShop: "Soul Shop", tDismantle: "🔮 Dismantle all dupes to souls <small>(keep 1st · SSR exempt)</small>", tAscBanner: "🔄 <b>Ascend ready</b> · +⬡ {e} now <span class=\"asc-prompt-cta\">tap →</span>", tCampaignChLabel: "📖 Campaign ch", synHeader: "⚡ Legion Synergy", diversity: "Diversity" });
Object.assign(I18N.ja, { evSeason: "シーズンイベント", shopGacha: "ガチャ", shopPack: "パック · 通貨", seasonSoon: "シーズン準備中", seasonHint: "限定イベント・ランキング報酬が近日", tArenaDone: "アリーナ本日5回完了", tArenaMatch: "アリーナマッチ (プレースホルダ) — Phase2で完全実装", tMystery: "❓ ??? : 秘密のレギオン窓。まもなく新モード公開! 今は好奇心だけ…", tCampaignCh: "📖 チャプター ch", tSoulShop: "ソウルショップ", tDismantle: "🔮 重複キャラ全部ソウル分解 <small>(1枚目保持・SSR除外)</small>", tAscBanner: "🔄 <b>転生可能</b> · 今転生で ⬡ +{e} <span class=\"asc-prompt-cta\">タップ →</span>", tCampaignChLabel: "📖 チャプター ch", synHeader: "⚡ 軍団シナジー", diversity: "多様性" });
Object.assign(I18N.zh, { evSeason: "赛季活动", shopGacha: "抽卡", shopPack: "礼包 · 货币", seasonSoon: "赛季活动准备中", seasonHint: "限时活动与排名奖励即将开启", tArenaDone: "今日竞技场5次完成", tArenaMatch: "竞技场匹配 (占位) — Phase2完整实现", tMystery: "❓ ??? : 秘密军团窗口。新模式即将公开！现在只有好奇心爆炸…", tCampaignCh: "📖 章节 ch", tSoulShop: "灵魂商店", tDismantle: "🔮 全部重复角色分解为灵魂 <small>(保留首张·SSR除外)</small>", tAscBanner: "🔄 <b>可转生</b> · 现在转生 ⬡ +{e} <span class=\"asc-prompt-cta\">点击 →</span>", tCampaignChLabel: "📖 章节 ch", synHeader: "⚡ 军团协同", diversity: "多样性" });
Object.assign(I18N.hi, { evSeason: "सीज़न इवेंट", shopGacha: "समन", shopPack: "पैक · करेंसी", seasonSoon: "सीज़न इवेंट जल्द", seasonHint: "लिमिटेड इवेंट और रैंकिंग इनाम", tArenaDone: "आज अखाड़ा 5 बार पूर्ण", tArenaMatch: "अखाड़ा मैच (प्लेसहोल्डर) — Phase2 में पूरा", tMystery: "❓ ??? : गुप्त लीजन विंडो। जल्द नया मोड! अभी सिर्फ जिज्ञासा...", tCampaignCh: "📖 अध्याय ch", tSoulShop: "आत्मा दुकान", tDismantle: "🔮 सभी डुप्लीकेट किरदार आत्मा में तोड़ें <small>(पहला रखें·SSR छोड़ें)</small>", tAscBanner: "🔄 <b>पुनर्जन्म तैयार</b> · अभी ⬡ +{e} <span class=\"asc-prompt-cta\">टैप →</span>", tCampaignChLabel: "📖 अध्याय ch", synHeader: "⚡ लीजन सिनर्जी", diversity: "विविधता" });
Object.assign(I18N.ru, { evSeason: "Сезонное событие", shopGacha: "Призыв", shopPack: "Наборы · Валюта", seasonSoon: "Сезон скоро", seasonHint: "Лимитные события и награды рейтинга", tArenaDone: "Сегодня арена 5 раз завершена", tArenaMatch: "Арена матч (плейсхолдер) — полный в Phase2", tMystery: "❓ ??? : Тайное окно Легиона. Скоро новый режим! Пока лишь любопытство взрывается?", tCampaignCh: "📖 Глава ch", tSoulShop: "Магазин душ", tDismantle: "🔮 Все дубликаты героев в души <small>(1-й сохранить·SSR исключить)</small>", tAscBanner: "🔄 <b>Перерождение доступно</b> · сейчас ⬡ +{e} <span class=\"asc-prompt-cta\">тап →</span>", tCampaignChLabel: "📖 Глава ch", synHeader: "⚡ Синергия Легиона", diversity: "Разнообразие" });
...
const SHOP2_I18N = {
  ...
  en: { pkMonthly: "📅 Monthly Pass · 💎300 now + 💎100/day×30", pkWeekly: "📅 Weekly Pass · 💎150 now + 💎100/day×7", pkGrow1: "📦 Growth Pack · 💰50k+💎200+2 SR gear", pkGrow2: "🎁 Premium Growth · 💰200k+💎800+SSR unit+gear", pkStarter: "💎 Starter Pack · 2x speed permanent + +20% gold permanent + 3,000 gold instant + 10 units", passDaily: "Pass reward 💎+{n}", tMonthly: "📅 Monthly Pass active! 💎300 + 💎100/day", tWeekly: "📅 Weekly Pass active! 💎150 + 💎100/day", tGrowth: "🎁 Growth pack acquired!" },
  ja: { pkMonthly: "📅 月間パス · 即💎300 + 30日毎日💎100", pkWeekly: "📅 週間パス · 即💎150 + 7日毎日💎100", pkGrow1: "📦 成長パック · 💰5万+💎200+SR装備×2", pkGrow2: "🎁 上級成長パック · 💰20万+💎800+SSRユニット+装備", pkStarter: "💎 初心者パック · 2x速度永久 + ゴールド+20%永久 + 即3000ゴールド + ユニット10体", passDaily: "パス報酬 💎+{n}", tMonthly: "📅 月間パス有効! 💎300 + 毎日💎100", tWeekly: "📅 週間パス有効! 💎150 + 毎日💎100", tGrowth: "🎁 成長パック獲得!" },
  zh: { pkMonthly: "📅 月卡 · 立即💎300 + 30天每日💎100", pkWeekly: "📅 周卡 · 立即💎150 + 7天每日💎100", pkGrow1: "📦 成长礼包 · 💰5万+💎200+SR装备×2", pkGrow2: "🎁 高级成长礼包 · 💰20万+💎800+SSR单位+装备", pkStarter: "💎 新手礼包 · 永久2x速度 + 金币+20%永久 + 立即3000金币 + 10单位", passDaily: "通行证奖励 💎+{n}", tMonthly: "📅 月卡激活! 💎300 + 每日💎100", tWeekly: "📅 周卡激活! 💎150 + 每日💎100", tGrowth: "🎁 获得成长礼包!" },
  hi: { pkMonthly: "📅 मासिक पास · तुरंत💎300 + 30दिन💎100/दिन", pkWeekly: "📅 साप्ताहिक पास · तुरंत💎150 + 7दिन💎100/दिन", pkGrow1: "📦 ग्रोथ पैक · 💰50k+💎200+2 SR गियर", pkGrow2: "🎁 प्रीमियम ग्रोथ · 💰200k+💎800+SSR यूनिट+गियर", pkStarter: "💎 स्टार्टर पैक · स्थायी 2x गति + गोल्ड+20% स्थायी + तुरंत 3000 गोल्ड + 10 यूनिट", passDaily: "पास इनाम 💎+{n}", tMonthly: "📅 मासिक पास चालू! 💎300 + 💎100/दिन", tWeekly: "📅 साप्ताहिक पास चालू! 💎150 + 💎100/दिन", tGrowth: "🎁 ग्रोथ पैक मिला!" },
  ru: { pkMonthly: "📅 Месячный пропуск · 💎300 + 💎100/день×30", pkWeekly: "📅 Недельный пропуск · 💎150 + 💎100/день×7", pkGrow1: "📦 Пакет роста · 💰50k+💎200+2 SR снаряги", pkGrow2: "🎁 Премиум рост · 💰200k+💎800+SSR юнит+снаряга", pkStarter: "💎 Набор новичка · Постоянная 2x скорость + +20% золота навсегда + сразу 3000 золота + 10 юнитов", passDaily: "Награда пропуска 💎+{n}", tMonthly: "📅 Месячный активен! 💎300 + 💎100/день", tWeekly: "📅 Недельный активен! 💎150 + 💎100/день", tGrowth: "🎁 Пакет роста получен!" },
};
