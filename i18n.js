...
const ODDS_I18N = {
  ko: { oddsGemTitle: "젬 가챠", oddsGoldTitle: "골드 가챠", oddsGoldNote: "※ 골드 가챠는 SSR 미등장 (SSR은 젬 가챠 전용)", oddsBtn: "📊 전체 확률 보기", oddsTitle: "📊 뽑기 확률 전체 공개", oddsPity: "천장: 12회 뽑으면 SSR 확정 · 7회부터 SSR 확률 상승(+4%/pull). 표시 확률은 게임 코드와 100% 일치합니다.", oddsFict: "※ 이 가챠·기원 드롭은 Legion Chronicles 내 가상의 서사( fictional narrative )입니다. 모든 재화·이벤트는 게임 내 전용. 실제 확률은 항상 코드와 일치 공개.", grNote: "🎯 12회 천장 = SSR 확정 · 7회부터 +4%/pull · 장비도 동일 확률" },
...
const RUNTIME_I18N = {
  ...
  en: {
    ...
    ageBody2: "Are you <b style=\"color:#fff;\">18+</b>, or if a minor, do you have <b style=\"color:#fff;\">parental/guardian consent</b>?<br><span style=\"font-size:11px;color:#7a7a96;\">Are you 18+ or have parental/guardian consent?</span>",
  ...
  zh: {
    ...
    shareCarry: "📤 分享 MY Legion carry", shareResult: "📤 分享结果 (邀请好友)",
  ...
  hi: {
    ...
    shareCarry: "📤 MY Legion carry शेयर करें", shareResult: "📤 परिणाम शेयर (दोस्त बुलाएँ)",
...
const GACHA_I18N = {
  ko: {
    ...
    originReveal: "🔓 {f} — {name} 기원 확인됨. (Legion Chronicles 내 fictional)",
    ...
    dalioWindow: "⏳ Dalio window... pity {p}/12. MY Legion almost. 영구 공백 위기. Seize now.",
  ...
  en: {
    ...
    dalioWindow: "⏳ Dalio window... pity {p}/12. MY Legion almost. Permanent gap risk. Seize now.",
  ...
  ja: {
    ...
    dalioWindow: "⏳ Dalio window... pity {p}/12. MY Legion almost. 永久の空白の危機。今掴め。",
  ...
  zh: {
    ...
    dalioWindow: "⏳ Dalio window... 保底 {p}/12。MY Legion 就差一点。永久空缺危机。趁现在。",
  ...
  hi: {
    ...
    dalioWindow: "⏳ Dalio window... पिटी {p}/12. MY Legion लगभग। स्थायी कमी का खतरा। अभी पकड़ो।",
  ...
  ru: {
    ...
    dalioWindow: "⏳ Dalio window... гарант {p}/12. MY Legion почти. Риск вечного пробела. Хватай сейчас.",
...
const ROSTER_I18N = {
  ko: {
    ...
    srName: ["와스프","헌터","불워크","크래셔","택틱스","골렘","글리치","바이퍼","타워","램페이지","마샬","베히모스","호크아이","사일런서","램파트","브레이커","바이저","콜로서스","팬텀","아처","캐슬","슬래머","워든","와이번","버즈","매","수호자","분쇄기","총수","마룡"],
    srTitle: ["독침의 정찰","추격의 사수","철벽의 수호","분쇄의 돌격","전술의 지휘","거석의 파수","교란의 정찰","맹독의 사격","거탑의 방벽","난동의 돌격","원수의 통솔","거수의 진격","감시의 비행","무음의 저격","성루의 방어","파쇄의 강습","책략의 군사","거상의 군림","은신의 추적","정밀의 명사수","요새의 방패","강타의 파괴","통솔의 사령","비룡의 강하","군집의 비행","추적의 사수","방벽의 수호","강습의 돌격","전술의 지휘","거신의 파수"],
  ...
  en: {
    ...
    srName: ["Wasp","Hunter","Bulwark","Crasher","Tactics","Golem","Glitch","Viper","Tower","Rampage","Marshal","Behemoth","Hawkeye","Silencer","Rampart","Breaker","Visor","Colossus","Phantom","Archer","Castle","Slammer","Warden","Wyvern","Buzz","Hawk","Guardian","Crusher","Gunner","Wyrm"],
    srTitle: ["Sting Scout","Pursuit Shooter","Iron Guard","Crushing Charge","Tactical Command","Megalith Watch","Jamming Scout","Venom Shot","Great Tower Wall","Rampage Charge","Marshal's Command","Behemoth Advance","Surveillance Flight","Silent Snipe","Bastion Defense","Shatter Assault","Schemer's Strategy","Colossus Reign","Stealth Pursuit","Precision Marksman","Fortress Shield","Smashing Destruction","Commanding Officer","Wyvern Descent","Swarm Flight","Tracking Shooter","Wall Guardian","Assault Charge","Tactical Command","Colossus Watch"],
