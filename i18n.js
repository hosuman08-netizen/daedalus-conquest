...
// 🏆 시즌 배틀패스
Object.assign(I18N.ko, { seasonXp: "이번 주 시즌 XP: {n}", seasonFree: "무료", seasonPrem: "프리미엄", seasonPremOff: "(패스 필요)", seasonClaim: "받기", seasonReward: "시즌 보상 획득! {r}", seasonClaimed: "이미 받음", seasonLocked: "{n} XP 필요", seasonPremReq: "프리미엄 트랙은 활성 패스가 필요합니다" });
Object.assign(I18N.en, { seasonXp: "Season XP this week: {n}", seasonFree: "Free", seasonPrem: "Premium", seasonPremOff: "(pass needed)", seasonClaim: "Claim", seasonReward: "Season reward! {r}", seasonClaimed: "Already claimed", seasonLocked: "{n} XP needed", seasonPremReq: "Premium track needs an active pass" });
Object.assign(I18N.ja, { seasonXp: "今週のシーズンXP: {n}", seasonFree: "無料", seasonPrem: "プレミアム", seasonPremOff: "(パス必要)", seasonClaim: "受取", seasonReward: "シーズン報酬獲得! {r}", seasonClaimed: "受取済み", seasonLocked: "{n} XP必要", seasonPremReq: "プレミアムトラックは有効なパスが必要です" });
...
const GACHA_I18N = {
  ko: {
    ...
    exArrival: "🌌 초월 영웅 강림!", urArrival: "🌀 전설+ 영웅 합류", ssrArrival: "✨ 전설의 영웅이 군단에 합류했습니다", ssrForged: "⚔️ 당신의 군단에 새겨졌습니다. 이 순간을 아끼세요.",
    ...
    gachaPityNote: "🎯 천장 {p}/12 · {rates} · 12연 도달 시 SSR 확정", dupeBadge: "중복",
  ...
  en: {
    ...
    exArrival: "🌌 Transcendent hero descends!", urArrival: "🌀 Legend+ hero joins", ssrArrival: "✨ A legendary hero joins your legion", ssrForged: "⚔️ Forged into your legion. Cherish this moment.",
    ...
    gachaPityNote: "🎯 Pity {p}/12 · {rates} · SSR guaranteed by pull 12", dupeBadge: "DUP",
  ...
  ja: {
    ...
    exArrival: "🌌 超越英雄降臨!", urArrival: "🌀 伝説+英雄が合流", ssrArrival: "✨ 伝説の英雄が軍団に合流", ssrForged: "⚔️ 君の軍団に刻まれた。この瞬間を大切に。",
    ...
    gachaPityNote: "🎯 天井 {p}/12 · {rates} · 12回でSSR確定", dupeBadge: "重複",
  ...
  zh: {
    ...
    exArrival: "🌌 超越英雄降临!", urArrival: "🌀 传说+英雄加入", ssrArrival: "✨ 传说英雄加入军团", ssrForged: "⚔️ 已铭刻入你的军团。请珍惜此刻。",
    ...
    gachaPityNote: "🎯 保底 {p}/12 · {rates} · 抽满12次必得SSR", dupeBadge: "重复",
  ...
  hi: {
    ...
    exArrival: "🌌 पारलौकिक हीरो अवतरित!", urArrival: "🌀 लीजेंड+ हीरो शामिल", ssrArrival: "✨ पौराणिक हीरो लीजन में शामिल", ssrForged: "⚔️ आपके लीजन में अंकित। इस पल को सहेजें।",
    ...
    gachaPityNote: "🎯 पिटी {p}/12 · {rates} · 12वें पुल पर SSR निश्चित", dupeBadge: "डुप्लि",
  ...
  ru: {
    ...
    exArrival: "🌌 Явился запредельный герой!", urArrival: "🌀 Легенда+ герой присоединился", ssrArrival: "✨ Легендарный герой вступил в легион", ssrForged: "⚔️ Вписан в твой легион. Береги этот миг.",
    ...
    gachaPityNote: "🎯 Гарант {p}/12 · {rates} · SSR гарантирован на 12-м", dupeBadge: "дубль",
...
const G6 = {
  ...
  hi: {
    ...
    claimAllBtn: "सभी लें ({n})", playStreakFoot: "⏰ रीसेट ~{h}h · 🔥 streak {s} (claim से बनाए रखें)", playHalfWarn: "पूरा इनाम पाने को 1+ एक्शन (युद्ध/पुल) करें!", playMoreToast: "1 युद्ध → कल बड़ा इनाम! (ऑफलाइन बूस्ट)", vanguardEvent: "⚡ 24घं फोकस — कल बड़ी पावर वृद्धि", missToday: "आज मिशन: युद्ध {b}/3 · पुल {p}/1 · ULT {u}/1 · टावर {tw}/1 ", missClaimBtn: "लें +800g + कल AFK 15% बूस्ट", missHabit: "आज पूरा → कल AFK +15% (आदत लूप)", playNowReset: "{m} मि खेला · 0 बजे रीसेट", fomoReset: "⏰ रीसेट में ~{h} घंटे (चूके तो streak रीसेट) · आज लें कल पावर UP", attendLoyalty: "🏅 {d}-दिन चेक-इन वफादारी इनाम! {extra}", ritualDone: "रिचुअल पूर्ण — एक गाचा घुमाएँ?", insightBonus: "🪞 अंतर्दृष्टि बोनस +{n} गोल्ड!", streak7: "7-दिन streak! कल 2x इनाम (चूके तो रीसेट)", missIncomplete: "मिशन अधूरा — युद्ध/पुल/ULT/टावर एक-एक बार", missComplete: "🎁 मिशन पूर्ण! +800g + कल AFK +15% (ऑफलाइन बूस्ट)", battleMore: "1 और युद्ध → streak/इनाम बढ़े! (3-5 मिनट लूप)", inviteLinkCopied: "आमंत्रण लिंक कॉपी", omRitualDone: "🔮 रिचुअल पूर्ण — गाचा तैयार!", sovereignOnly: "केवल Sovereign", firstPay2x: "🎉 पहली खरीद 2x बोनस! (गोल्ड·जेम दोगुना)", firstPay2xToast: "🎉 पहली खरीद 2x बोनस! ", founderCrown: "🏅 फाउंडर बने! स्थायी बैज + गोल्ड +25%", tonToast: "TON stealth एंट्री + X funnel credit",
...
// 잔여 2종 (동시편집 유입분 포함)
Object.assign(I18N.ko, { firstClearToast: "🎯 첫 지휘 성공 — 이 군단은 네 것", sfActivated: "⚔️ 특수부대 일당10000 유닛 가동! MY Legion", d1HookTitle: "내일 이 군단이 더 세진다", d1HookBody: "🎟️ 내일 무료 소환 · 🔥 연속 출석 보상 · 같은 영웅 강화로 파워 상승", d1HookCta: "다음 전투로 ▶", d1HookClose: "닫기" });
Object.assign(I18N.en, { firstClearToast: "🎯 First command success — this legion is yours", sfActivated: "⚔️ Special Forces 10000-unit ops active! MY Legion", d1HookTitle: "Tomorrow this legion gets stronger", d1HookBody: "🎟️ Free summon tomorrow · 🔥 Streak rewards · Power grows with the same heroes", d1HookCta: "Next battle ▶", d1HookClose: "Close" });
Object.assign(I18N.ja, { firstClearToast: "🎯 初指揮成功 — この軍団は君のもの", sfActivated: "⚔️ 特殊部隊 日当10000ユニット稼働! MY Legion", d1HookTitle: "明日この軍団はさらに強くなる", d1HookBody: "🎟️ 明日の無料召喚 · 🔥 連続ログイン · 同じ英雄を強化", d1HookCta: "次の戦闘へ ▶", d1HookClose: "閉じる" });
Object.assign(I18N.zh, { firstClearToast: "🎯 首次指挥成功 — 这支军团是你的", sfActivated: "⚔️ 特种部队 日产10000单位启动! MY Legion", d1HookTitle: "明天这支军团会更强", d1HookBody: "🎟️ 明日免费召唤 · 🔥 连续签到 · 强化同一英雄", d1HookCta: "下一场战斗 ▶", d1HookClose: "关闭" });
...
// 🏅 후원자 사다리 (Patron Ladder) — 코스메틱 타이틀 + 월 지출캡 공개
Object.assign(I18N.ko, { patronTitle: "후원자 사다리", patronBtn: "🏅 후원자 사다리", patronNoTitle: "아직 타이틀 없음", patronTotal: "누적 후원", patronNext: "다음: ⭐{n} → {t}", patronMax: "✨ 최고 등급 달성!", patronClaimBtn: "받기", patronClaimed: "타이틀 획득!", patronUnlocked: "새 후원 타이틀 해금! 후원자 사다리에서 받기", patronCapLabel: "이번 달 지출", patronCapNote: "스스로 정하는 월 상한선입니다(결제를 막지 않아요). 게임은 오락이며 투자가 아닙니다. 무리하지 마세요.", patronCosmeticNote: "보상은 순수 코스메틱 타이틀 — 전투력에 영향 없음." });
Object.assign(I18N.en, { patronTitle: "Patron Ladder", patronBtn: "🏅 Patron Ladder", patronNoTitle: "No title yet", patronTotal: "Lifetime support", patronNext: "Next: ⭐{n} → {t}", patronMax: "✨ Top tier reached!", patronClaimBtn: "Claim", patronClaimed: "title earned!", patronUnlocked: "New patron title unlocked! Claim it in the Patron Ladder", patronCapLabel: "This month's spend", patronCapNote: "A monthly cap you set for yourself (it does not block purchases). Games are entertainment, not investment. Please play within your means.", patronCosmeticNote: "Rewards are purely cosmetic titles — no effect on power." });
Object.assign(I18N.ja, { patronTitle: "パトロンラダー", patronBtn: "🏅 パトロンラダー", patronNoTitle: "称号なし", patronTotal: "累計支援", patronNext: "次: ⭐{n} → {t}", patronMax: "✨ 最高ランク達成!", patronClaimBtn: "受取", patronClaimed: "称号獲得!", patronUnlocked: "新しいパトロン称号解禁! ラダーで受取", patronCapLabel: "今月の支出", patronCapNote: "自分で決める月間上限です(購入は止めません)。ゲームは娯楽であり投資ではありません。無理のない範囲で。", patronCosmeticNote: "報酬は純粋な称号 — 戦力に影響なし。" });
Object.assign(I18N.zh, { patronTitle: "赞助者阶梯", patronBtn: "🏅 赞助者阶梯", patronNoTitle: "暂无称号", patronTotal: "累计赞助", patronNext: "下一级: ⭐{n} → {t}", patronMax: "✨ 已达最高级!", patronClaimBtn: "领取", patronClaimed: "获得称号!", patronUnlocked: "解锁新赞助称号! 到阶梯领取", patronCapLabel: "本月支出", patronCapNote: "这是你为自己设定的月度上限(不会阻止购买)。游戏是娱乐而非投资,请量力而行。", patronCosmeticNote: "奖励为纯外观称号 — 不影响战力。" });
Object.assign(I18N.hi, { patronTitle: "पैट्रन सीढ़ी", patronBtn: "🏅 पैट्रन सीढ़ी", patronNoTitle: "अभी कोई खिताब नहीं", patronTotal: "कुल समर्थन", patronNext: "अगला: ⭐{n} → {t}", patronMax: "✨ शीर्ष स्तर!", patronClaimBtn: "लें", patronClaimed: "खिताब मिला!", patronUnlocked: "नया पैट्रन खिताब अनलॉक! सीढ़ी में लें", patronCapLabel: "इस माह खर्च", patronCapNote: "यह आपकी अपनी तय मासिक सीमा है (खरीद नहीं रोकती)। खेल मनोरंजन है, निवेश नहीं। अपनी क्षमता में खेलें।", patronCosmeticNote: "इनाम केवल कॉस्मेटिक खिताब — शक्ति पर असर नहीं।" });
Object.assign(I18N.ru, { patronTitle: "Лестница покровителя", patronBtn: "🏅 Лестница покровителя", patronNoTitle: "Пока нет титула", patronTotal: "Всего поддержки", patronNext: "Далее: ⭐{n} → {t}", patronMax: "✨ Высший ранг!", patronClaimBtn: "Забрать", patronClaimed: "титул получен!", patronUnlocked: "Открыт новый титул! Заберите на Лестнице покровителя", patronCapLabel: "Расходы за месяц", patronCapNote: "Это лимит, который вы задаёте себе сами (он не блокирует покупки). Игры — развлечение, а не инвестиции. Играйте по средствам.", patronCosmeticNote: "Награды — чисто косметические титулы, не влияют на силу." });
// 🎺 길드 응원(프리셋 이모트) — 자유입력 없음
Object.assign(I18N.ko, { guildCheerTitle: "군단 응원", emoCharge: "돌격!", emoFire: "불태워라!", emoHold: "전열 사수!", emoStrong: "우린 강하다!", emoGG: "잘 싸웠다!", emoGlory: "군단에 영광을!", emoThanks: "고맙다 형제여!", emoRally: "집결하라!" });
Object.assign(I18N.en, { guildCheerTitle: "Legion cheers", emoCharge: "Charge!", emoFire: "Burn them!", emoHold: "Hold the line!", emoStrong: "We are strong!", emoGG: "Well fought!", emoGlory: "Glory to the Legion!", emoThanks: "Thank you, brother!", emoRally: "Rally up!" });
Object.assign(I18N.ja, { guildCheerTitle: "軍団の声援", emoCharge: "突撃!", emoFire: "焼き尽くせ!", emoHold: "戦線を守れ!", emoStrong: "我らは強い!", emoGG: "よく戦った!", emoGlory: "軍団に栄光を!", emoThanks: "ありがとう兄弟!", emoRally: "集結せよ!" });
Object.assign(I18N.zh, { guildCheerTitle: "军团助威", emoCharge: "冲锋!", emoFire: "烧了他们!", emoHold: "守住阵线!", emoStrong: "我们很强!", emoGG: "打得好!", emoGlory: "荣耀归军团!", emoThanks: "谢谢兄弟!", emoRally: "集结!" });
Object.assign(I18N.hi, { guildCheerTitle: "लीजन जयकार", emoCharge: "हमला!", emoFire: "जला दो!", emoHold: "मोर्चा संभालो!", emoStrong: "हम मजबूत हैं!", emoGG: "अच्छा लड़े!", emoGlory: "लीजन की जय!", emoThanks: "शुक्रिया भाई!", emoRally: "एकजुट हो!" });
Object.assign(I18N.ru, { guildCheerTitle: "Кличи легиона", emoCharge: "В атаку!", emoFire: "Сжечь их!", emoHold: "Держать строй!", emoStrong: "Мы сильны!", emoGG: "Славный бой!", emoGlory: "Слава легиону!", emoThanks: "Спасибо, брат!", emoRally: "Сплотиться!" });
